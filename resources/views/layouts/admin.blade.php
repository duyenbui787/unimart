...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/f5kg8tfc856tat8lkskd0dw9bihoxp37esk9ku1m726bo95i/tinymce/4/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        var editor_config = {
            path_absolute: "http://localhost/backend-laravel/UNIMART/",
            selector: "textarea",
            plugins: [
